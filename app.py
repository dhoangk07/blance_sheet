...
bar_chart_by_streamlit("Tiền điện", 'Must Have')
bar_chart_by_streamlit("Cơm tấm", 'Must Have')
bar_chart_by_streamlit("Bánh mì", 'Must Have')
bar_chart_by_streamlit("Cheng an", 'Must Have')
...
bar_chart_by_streamlit("Nhậu", 'Nice To Have')
bar_chart_by_streamlit("Vật tư trồng cây", 'Nice To Have')
